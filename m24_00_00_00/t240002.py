...
def t240002_0():
    """State 0,1"""
    t240002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, flag3=240, flag4=2, action1=10010715)
    Quit()

def t240002_x0():
    """State 0,1"""
    assert t240002_x7(z1=99999, z2=99999, z3=99999, z4=99999)
    """State 2"""
    return 0

def t240002_x1(flag1=6000, flag2=6001, actionbutton1=6100, actionbutton2=6101, flag3=240, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        DebugEvent('地上子ワープ椅子_非マルチ中')
        call = t240002_x3(actionbutton1=actionbutton1, actionbutton2=actionbutton2, flag3=flag3, flag4=flag4,
                          action1=action1)
        if IsMultiplayerInProgress() == 1:
            """State 1"""
            DebugEvent('地上子ワープ椅子_マルチ中')
            call = t240002_x2(actionbutton1=actionbutton1, flag3=flag3, flag4=flag4, action1=action1)
...
def t240002_x2(actionbutton1=6100, flag3=240, flag4=2, action1=10010715):
    """State 0,3"""
    ForceCloseMenu()
    while True:
        """State 2"""
        if GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20) == 1:
            ...
            SetTalkTime(0.33)
            """State 5"""
            call = t240002_x8(flag3=flag3, flag4=flag4, action1=action1)
            if call.Done():
                pass
...
def t240002_x3(actionbutton1=6100, actionbutton2=6101, flag3=240, flag4=2, action1=10010715):
    """State 0"""
    while True:
        """State 2"""
        Label('L0')
        ...
        if not GetEventStatus(10007810 + flag3 * 10000 + flag4 * 20):
            ...
            SetTalkTime(0.33)
            """State 6"""
            call = t240002_x4(flag3=flag3, flag4=flag4, action1=action1)
            if call.Done():
                pass
            elif GetDistanceToPlayer() > 3 or HasPlayerBeenAttacked() == 1:
                """State 5"""
...
def t240002_x4(flag3=240, flag4=2, action1=10010715):
    while True:
        ClearTalkListData()
        ...
        if not GetTalkListEntryResult() or GetTalkListEntryResult() == 99 or not IsTalkExclusiveMenuOpen():
            ...
            if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1):
                ...
                if GetGenericDialogButtonResult() == 1:
                    DebugEvent('OK')
                    assert t240002_x6(flag3=flag3, flag4=flag4, z5=0)
...
def t240002_x6(flag3=240, flag4=2, z5=0):
    """State 0,1"""
    SetEventState(flag3 * 10000 + 70000100 + flag4 * 1, 1)
    """State 2"""
    return 0

def t240002_x7(z1=99999, z2=99999, z3=99999, z4=99999):
    """State 0,1"""
    DebugEvent('会話判定')
...
def t240002_x8(flag3=240, flag4=2, action1=10010715):
    """State 0,2"""
    if not GetEventStatus(flag3 * 10 + 70000000 + flag4 * 1):
        """State 3"""
